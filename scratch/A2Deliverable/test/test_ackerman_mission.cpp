...
///////////////////////////////////////////////////////////
// Ackerman Mission Interrupt/Resume Test
///////////////////////////////////////////////////////////

/**
 * @brief Validates correct behaviour when an active Ackerman mission is
 * interrupted and resumed with new goals via the Mission interface.
 *
 * Test flow:
 *  1.  Teleport Ackerman to start, create controller + Mission (BASIC)
 ...
 *  5.  Set new goals via mission->setGoals, execute(true) — verify RUNNING
 ...
 */
TEST(AckermanMission, InterruptAndResume) {
    ...
    // Initial goals — straightforward for Ackerman from (0,2)
    std::vector<pfms::geometry_msgs::Point> initialGoals;
    initialGoals.push_back({ 20.0,   0.0, 0.0});
    initialGoals.push_back({ 30.0, -10.0, 0.0});
    initialGoals.push_back({ 20.0, -20.0, 0.0});
    ...
    // ── Phase 4: Set new goals and resume ─────────────────────────────────────
    std::vector<pfms::geometry_msgs::Point> newGoals;
    newGoals.push_back({ 30.0, -30.0, 0.0});
    newGoals.push_back({ 35.0, -45.0, 0.0});
    ...
    // ── Summary ───────────────────────────────────────────────────────────────
    std::cout << "\n========== TEST SUMMARY: AckermanMission/InterruptAndResume ==========\n";
