...
// Below is a main function, which is used to create the executable
// However, we do not use main.cpp in testing your implementation, the unit tests are used instead
