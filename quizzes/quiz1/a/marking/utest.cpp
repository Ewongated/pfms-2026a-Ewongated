...
TEST(ClassTest, CreateObject) {
   ...
   // If we initialize Model with 100 and "true" for charging status, the constructor should set the charging to false.
   // This is because the role of constructor is to set the charging status correctly. 
   // We need to fix this in the constructor of the Charger class.    
}
