...
We introduce one new concept from C++ that we will use extensively going forward, a vector. 

Vectors belong to the Standard Template Library (STD) that is part of C++ suite of libraries. With this, our journey into C++ features begins in week 1!

**[TUTORIAL](./TUTORIAL.md)**



<img src="https://img.devrant.com/devrant/rant/r_77251_3xSNn.jpg" style="zoom:50%;" />
