...
Building up from the pre-work we examine (1) functions (2) structs and (3) vectors. 

Finally we combine all the knowledge on creating a executable to simulate an air-conidtion unit.
...
![](./media/figure-1-state-machines.png)
...
#### To implement a simulator of the air-con we will simplify it

We don't have a sensor or button to User Interface - UI) and therefore:
