...
bool Quadcopter::reachGoal(void) {
  ...
  //! @todo TASK 2 -- add a pure virtual function to the interface for the service of type std_srvs::srv::SetBool
  //! follow the README for the logic as to how it interfaces to state machine and what it returns
