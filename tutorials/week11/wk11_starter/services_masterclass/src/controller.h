...
void setGoal(const geometry_msgs::msg::Point& msg);  
  ...
  */
  ...
  //! @todo TASK 2 -- add a pure virtual function called control to the interface for the service of type std_srvs::srv::SetBool
  /**
...
private: 
  ...
  //! @todo TASK 2 -- Add SharedPtr for the service of type std_srvs::srv::SetBool
