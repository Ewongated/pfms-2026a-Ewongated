...
You have already installed ROS2 and set-up your ros2 workspace `ros2_ws` at the beginning of the semester (you have this already done on Azure). This is needed both for quiz4 as well as tutorial this week. 

You need to complete  [CANVAS Week 09 Prework](https://canvas.uts.edu.au/courses/30581/pages/week-09-prework) to effectively partake in the **[TUTORIAL](./TUTORIAL.md)**
