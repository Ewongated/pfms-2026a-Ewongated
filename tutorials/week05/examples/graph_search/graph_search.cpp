...
/*! A utility function to print stack
...
/*! reconstructs the path from the start node to the goal node
    given a map of parent nodes.
    \param parents a map of child->parent node
    \param goal the goal node
    \return a vector of nodes from start to goal
*/
...
/*! performs a depth first search on a graph
    ...
    \return a vector of nodes from start to goal
*/
vector<int> depth_first_search(AdjacencyList& graph, int start, int goal) {
